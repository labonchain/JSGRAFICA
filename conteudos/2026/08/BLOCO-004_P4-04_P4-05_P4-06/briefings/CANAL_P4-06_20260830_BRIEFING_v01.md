...
**Pauta:** Presente que guarda uma lembrança
...
- Criar composição vertical nativa em `1080 x 1920 px`; não esticar nem apenas recortar a arte quadrada.
- Organizar os quatro objetos em sequência vertical leve, deixando título e CTA legíveis na área central.
- Preservar base azul e branca, fontes oficiais, uma única logo e respiro no topo/rodapé.

## Não incluir

- Fotos de família, nomes, frases de cliente, personagem, marca de terceiro, preço, prazo, tamanho, material ou disponibilidade.
- Fundo preto como base principal ou logo repetida.

## Critérios de aceite

- Os objetos são entendidos como personalizáveis sem expor arte de cliente.
- A peça tem clima afetivo, mas continua profissional e clara.
- Marca e tipografia seguem o manual.
