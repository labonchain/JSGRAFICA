...
| P2-07 | Cadernos, apostilas e materiais didáticos | P2 | AGUARDANDO_APROVACAO | Aprovação final do Edvam pra publicar | v01 | v01 | v01 (Canal + Status) | v01 | Aprovado pelo usuário (briefing) | - | QA aprovado (squad js-grafica-canal-conteudo, 30/08); aguardando aprovação final |
| P2-08 | Impressão em papel couchê | P2 | AGUARDANDO_APROVACAO | Aprovação final do Edvam pra publicar | v01 | v01 | v01 (Canal + Status) | v01 | Aprovado pelo usuário (briefing) | - | QA aprovado (squad js-grafica-canal-conteudo, 30/08); aguardando aprovação final |
| P2-09 | Impressão em papel cartão | P2 | AGUARDANDO_APROVACAO | Aprovação final do Edvam pra publicar | v01 | v01 | v01 (Canal + Status) | v01 | Aprovado pelo usuário (briefing) | - | QA aprovado (squad js-grafica-canal-conteudo, 30/08); aguardando aprovação final |
| P2-10 | Impressão em papel adesivo | P2 | AGUARDANDO_APROVACAO | Aprovação final do Edvam pra publicar | v01 | v01 | v01 (Canal + Status) | v01 | Aprovado pelo usuário (briefing) | - | QA aprovado (squad js-grafica-canal-conteudo, 30/08); aguardando aprovação final |
| P3-04 | Consulta e impressão de documentos | P3 | AGUARDANDO_APROVACAO | Aprovação final do Edvam pra publicar + validar operação no dia | v01 | v01 | v01 (Canal + Status) | v01 | Aprovado pelo usuário (briefing) | - | QA aprovado com correção de contraste na lupa (squad js-grafica-canal-conteudo, 30/08); aguardando aprovação final |
| P3-05 | Apoio de acesso ao Gov.br e serviços públicos online | P3 | AGUARDANDO_APROVACAO | Aprovação final do Edvam pra publicar + validar operação no dia | v01 | v01 | v01 (Canal + Status) | v01 | Aprovado pelo usuário (briefing) | - | QA aprovado com remoção de elemento que lembrava tela de login (squad js-grafica-canal-conteudo, 30/08); aguardando aprovação final |
